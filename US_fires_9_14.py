...
out_file = open("readable_fire_data_9_14.json", "w")
...
# This modular system is comprised of lists and dictionaries within lists.
# Also note at the end of this chunk, every magnitude within the list "mags" has been amplified by a factor of five.
data = [{
    "type": "scattergeo",
    "lon": lons,
    "lat": lats,
